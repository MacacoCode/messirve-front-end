...
const Post = ({
  ...
  return (
    ...
    >
      ...
      <Row>
        <Col span={8}>Precio: {selectedEmpresa.precioBase ? `CS$${selectedEmpresa.precioBase}` : "No Disponible"}</Col>
        <Col span={8} offset={8}>Marca: {marca || "Sin Marca"}</Col>
      </Row>
      <Row>
        <Col span={10}><Rate allowHalf defaultValue={4.5} /></Col>
        <Col span={14} style={{ paddingTop: 7 }}>
          <Row>
            <Col offset={5}>
              Medidas: { medidas ? (
